  ...
  return (
    <div>
      <div className="d-flex flex-column justify-content-start align-items-start ju">
        ...
        <p> This is an Clone of Guvi zenclass learning
        website, which provides students login and admin login for learning and
        class management.</p>
      </div>
      <hr />
      <div className="d-flex flex-column justify-content-start align-items-start ju">
        ...
        <p>
          Powered by React Functional Component,Formik,Material UI, JavaScript
          and CSS
        </p>
