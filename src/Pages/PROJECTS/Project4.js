  ...
  return (
    <div>
      <div className="d-flex flex-column justify-content-start align-items-start ju">
        ...
        <p> This is an Simple ToDo application devolped using React in frontend where we can add task and edit task with completetion status.
        </p>
      </div>
      <hr />
      <div className="d-flex flex-column justify-content-start align-items-start ju">
        ...
        <p>
          Powered by React Functional Component,Material UI, Antd,Bootstrap, JavaScript
          and CSS in frontend.
          NodeJS,JWT authenitication, Express and Mongoose in Backend.
        </p>
